    ...
    'text' => '<h1>Поддержка</h1>
        ...
        <div class="faq-section">
            ...
            <div class="faq-item">
                ...
                <div class="answer">
                    <span>О:</span> С каждой игры мы берем комиссию 10%
                </div>
            </div> <!-- End of FAQ item -->

            <div class="faq-item">
                <div class="question">
                    <span>В:</span> Мне не пришел выигрыш!
                </div>
                <div class="answer">
                    <span>О:</span> Отправка предметов может занимать до 30 минут (в зависимости от загруженности ботов), а также обратите внимание на то, что в настройках приватности вашего аккаунта Steam ваш инвентарь должен быть открыт: <a href="http://steamcommunity.com/id/me/edit/settings/">http://steamcommunity.com/id/me/edit/settings/</a>
                </div>
            </div> <!-- End of FAQ item -->
        ...
        <div class="feedback">
            ...
            <p>Если вы здесь не нашли ответа на ваш вопрос, тогда вы можете задать его нашему саппорту через почту</p>

            <div class="feedback-button">
                <a href="https://vk.com/cshot_vk">Отправить сообщение поддержке</a>
            </div>
