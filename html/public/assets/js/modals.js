$(function() {
    var deposit ='';
    deposit += '<div style="display: none;">';
    deposit += '    <div id="deposit" class="itemmodal" style="width: 600px; padding: 20px;">';
    deposit += '        <div class="box-modal_close arcticmodal-close mini"></div>';
    deposit += '        <div style="font-size: 13px; line-height: 17px;">';
    deposit += '            <div style="line-height: 15px;">';
    deposit += '                <a class="vksupBtn" href="/deposit" target="_blank">ВЛОЖИТЬ ЧЕРЕЗ БРАУЗЕР</a><a class="vksupBtn" href="/deposit2" target="_blank">ВЛОЖИТЬ ЧЕРЕЗ КЛИЕНТ</a>';
    deposit += '            </div>';
    deposit += '        </div>';
    deposit += '    </div>';
    deposit += '</div>';
